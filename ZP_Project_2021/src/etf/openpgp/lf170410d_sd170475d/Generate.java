		...
		btnSubmit.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (radioBtn_2048.isSelected())
					...
					value = 4096;
				try {
					String pass=JOptionPane.showInputDialog(null, "Unesite lozinku:", "Lozinka", JOptionPane.QUESTION_MESSAGE);
					while (pass.length()== 0) pass=JOptionPane.showInputDialog(null, "Unesite lozinku:", "Lozinka", JOptionPane.QUESTION_MESSAGE);
